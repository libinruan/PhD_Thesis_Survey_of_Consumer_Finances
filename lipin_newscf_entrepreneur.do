...
drop if no1!=1
keep agegroup `x' occat1
save stat`argu'_entrepreneur, replace
end
...
************************************
use stat2001_entrepreneur, clear
append using stat2004_entrepreneur
save temp, replace

forvalue var = 2007(3)2013{
	use temp, clear
	append using stat`var'_entrepreneur
	save temp, replace
}
sort agegroup
...
use stat2010_entrepreneur, clear
